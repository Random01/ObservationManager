          ...
          if (angular.isArray(translationId)) {
            var translateAll = function (translationIds) {
              ...
              var translate = function (translationId) {
                ...
                $translate.instant(translationId, interpolateParams, interpolationId).then(regardless, regardless);
        ...
        var determineTranslation = function (translationId, interpolateParams, interpolationId) {
          ...
          if (table && table.hasOwnProperty(translationId)) {
            ...
            if (translation.substr(0, 2) === '@:') {
              $translate.instant(translation.substr(2), interpolateParams, interpolationId).then(deferred.resolve, deferred.reject);
            } else {
                ...
                return function () {
                  var unwatch = scope.$watch('translationId', function (value) {
                      if (scope.translationId && value) {
                        $translate.instant(value, {}, translateInterpolation).then(function (translation) {
                ...
                return function () {
                  var updateTranslations = function () {
                    if (scope.translationId && scope.interpolateParams) {
                      $translate.instant(scope.translationId, scope.interpolateParams, translateInterpolation).then(function (translation) {
                        applyElementContent(translation, scope, true);
                      }, function (translationId) {
                        applyElementContent(translationId, scope, false);
                      });
