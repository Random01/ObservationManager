...
a.put("scripts/observation/site/site.html",'<div class="om-site-form"><div>{{\'OM.NAME\'|translate}}</div><input type="text" class="om-textbox" ng-model="site.name"/><div>{{\'OM.LONGITUDE\'|translate}}</div><input type="text" class="om-textbox" ng-model="site.longitude.value"/><div>{{\'OM.LATITUDE\'|translate}}</div><input type="text" class="om-textbox" ng-model="site.latitude.value"/><div>{{\'OM.TIME_ZONE\'|translate}}</div><input type="text" class="om-textbox" ng-model="site.timezone"/></div>');
a.put("scripts/observation/site/sites.html",'<div><a href="#sites/create">{{\'OM.CREATE_NEW_SITE\'|translate}}</a><div ng-repeat="site in sites"><div>{{scope.name}}</div><div><a ng-href="#sites/edit/{{scope.id}}">{{\'OM.CREATE\'|translate}}</a></div><div><a ng-href="#sites/delete/{{scope.id}}">{{\'OM.DELETE\'|translate}}</a></div></div></div>')}])})(angular.module("observationManager.common",[]));
(function(b){b.factory("omObservationManager",["$q",function(a){return{getAllObservations:function(a){}}}]);b.factory("omObservation",function(){var a=function(){};a.prototype.observer=null;a.prototype.site=null;a.prototype.session=null;a.prototype.target=null;a.prototype.begin=null;a.prototype.scope=null;return a});b.controller("omObservationsController",["$scope","omObservationManager",function(a,c){a.observations=[]}]);b.controller("omScopeController",["$scope","omScope","omScopeManager","$location",
function(a,c,b,d){a.scope=new c;a.create=function(){a.scope.isValid()&&b.add(a.scope).then(function(){d.path("scopes")})};a.cancel=function(){d.path("scopes")}}]);b.factory("omScopeManager",["$http","$q","_",function(a,c,b){a={};var d=[];a.getAllScopes=function(a){return c.when(d)};a.add=function(a){d.push(a);return c.when()};a.update=function(a){return c.when()};a.delete=function(a){return c.when()};a.getScopeById=function(a){return c.when()};return a}]);b.factory("omScope",function(){var a=function(a){a&&
(a.hasOwnProperty("id")&&(this.id=a.id),a.hasOwnProperty("model")&&(this.model=a.model),a.hasOwnProperty("aperture")&&(this.aperture=a.aperture),a.hasOwnProperty("focalLength")&&(this.focalLength=a.focalLength))};a.prototype.id=null;a.prototype.model=null;a.prototype.aperture=null;a.prototype.focalLength=null;a.prototype.isValid=function(){return null!=this.model&&""!=this.model};return a});b.controller("omScopesController",["$scope","omScopeManager",function(a,c){a.isLoading=!0;c.getAllScopes().then(function(c){a.isLoading=
!0;a.scopes=c})}]);b.controller("omSessionController",["$scope","omSession",function(a,c){a.languages=[{id:"ru",text:"Russian"},{id:"en",text:"English"}];a.session=new c({id:"some guid",lang:"en",begin:new Date,end:new Date,weather:"Cloudy",equipment:"Tea",comments:"Some comments"})}]);b.factory("omSession",function(){var a=function(a){a&&(a.hasOwnProperty("id")&&(this.id=a.id),a.hasOwnProperty("lang")&&(this.lang=a.lang),a.hasOwnProperty("begin")&&(this.begin=a.begin),a.hasOwnProperty("end")&&(this.end=
a.end),a.hasOwnProperty("site")&&(this.site=a.site),a.hasOwnProperty("weather")&&(this.weather=a.weather),a.hasOwnProperty("equipment")&&(this.equipment=a.equipment),a.hasOwnProperty("comments")&&(this.comments=a.comments))};a.prototype.id="";a.prototype.lang="";a.prototype.begin=null;a.prototype.end=null;a.prototype.site=null;a.prototype.weather="";a.prototype.equipment="";a.prototype.comments="";return a});b.controller("omSiteController",["$scope","omSite",function(a,c){a.site=new c({id:"some guid",
name:"Saratov",longitude:{unit:"deg",value:51.53},latitude:{unit:"deg",value:46.02},timezone:2})}]);b.factory("omSiteManager",["$q","omSite",function(a,c){return{getAllSites:function(b){b=[new c({name:"Saratov"}),new c({name:"Mokrous"})];return a.when(b)},add:function(){},update:function(){},delete:function(){},getsiteById:function(){}}}]);b.factory("omSite",function(){var a=function(a){a&&(a.hasOwnProperty("id")&&(this.id=a.id),a.hasOwnProperty("name")&&(this.name=a.name),a.hasOwnProperty("longitude")&&
(this.longitude=a.longitude),a.hasOwnProperty("latitude")&&(this.latitude=a.latitude),a.hasOwnProperty("timezone")&&(this.timezone=a.timezone))};a.prototype.id=null;a.prototype.name=null;a.prototype.longitude=null;a.prototype.latitude=null;a.prototype.timezone=0;a.prototype.isValid=function(){return!0};return a});b.controller("omSitesController",["$scope","omSiteManager",function(a,b){b.getAllScopes().then(function(b){a.sites=b})}])})(angular.module("observationManager.observation",[]));
(function(b){b.config(["$translateProvider","$windowProvider",function(a,b){var e=b.$get();a.preferredLanguage(e.navigator.userLanguage||e.navigator.language);a.fallbackLanguage("en-US")}]);b.config(["$translateProvider",function(a){a.translations("en-US",{OM:{NAME:"Name",LONGITUDE:"Longitude",LATITUDE:"Latitude",TIME_ZONE:"Timezone",LANGUAGE:"Language",BEGIN:"Begin",END:"End",WEATHER:"Weather",EQUIPMENT:"Equipment",COMMENTS:"Comments",SITE:"Site",NEW_SITE:"New Site",MODEL:"Model",APERTURE:"Aperture",
FOCAL_LENGTH:"Focal length",ADD:"Add",CANCEL:"Cancel"}})}])})(angular.module("observationManager.localization",["pascalprecht.translate"]));
